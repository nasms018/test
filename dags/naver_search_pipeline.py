...
# 본인이 발급받은 키를 넣으세요
NAVER_CLI_ID = "cjQ5E8NZQbmvDcumtAaj"
NAVER_CLI_SECRET = "z87lxXTTsq"
...
with DAG(
    ...
    store_result = BashOperator(
        task_id="store_naver",
        bash_command='echo -e ".separator ","\n.import /home/cjm1s/airflow/dags/data/naver_processed_result.csv naver_search_result" | sqlite3 /home/cjm1s/airflow/airflow.db'
    )
